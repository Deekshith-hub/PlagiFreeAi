          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <button
                ...
                className="flex items-center gap-1 sm:gap-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full px-3 sm:px-6 py-1.5 sm:py-2 text-xs sm:text-sm font-semibold transition-colors shadow-md shadow-indigo-500/30"
              >
